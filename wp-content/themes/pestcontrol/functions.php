<?php
/**
 * pestControl functions and definitions
 *
 * @package pestControl
 */
...
if ( ! function_exists( 'pestcontrol_setup' ) ) :
/**
 ...
 */
function pestcontrol_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on pestControl, use a find and replace
	 * to change 'pestcontrol' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'pestcontrol', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'pestcontrol' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'pestcontrol_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // pestcontrol_setup
add_action( 'after_setup_theme', 'pestcontrol_setup' );
 ...
 */
function pestcontrol_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'pestcontrol' ),
		'id'            => 'sidebar-1',
		'description'   => '',
